...
class GymColors extends ThemeExtension<GymColors> {
  ...
  static const light = GymColors(
    pageBg: Color(0xFFFFFDF9),
    bg: Color(0xFFFAF6ED),
    bgRaised: Color(0xFFFFFFFF),
    bgRaised2: Color(0xFFF4E7D8),
    border: Color(0xFFE9DECB),
    navBg: Color(0xF2FFFDF9),
    text: Color(0xFF1A1713),
    textSecondary: Color(0xFF5F574F),
    textTertiary: Color(0xFF8A8179),
    ember: Color(0xFF3B4835),
    emberDeep: Color(0xFF2C3627),
    onEmber: Color(0xFFFFFFFF),
    emberSoft: Color(0x123B4835),
    emberShadow: Color(0x1F3B4835),
    accent: Color(0xFF9E4E27),
    accentSoft: Color(0x1F9E4E27),
    brass: Color(0xFF8A6B41),
    sage: Color(0xFF3CC027),
    sageSoft: Color(0x1F1D9C1D),
    mutedFill: Color(0xFFF2E7D5),
    heatEmpty: Color(0xFFEFE8DA),
